"""File upload handling module for VITA Panel application."""
...
class FileUploader(param.Parameterized):
    """Handles Python file uploads and display with line numbers."""
    ...
    def view(self):
        """Display uploaded file content with line numbers."""
    ...
    def upload_file(self, event):
        """Handle file upload event and update global test variable."""
        if self.file_input.value:
            ...
            # Update the global test variable by importing here to avoid circular imports
            import vita_app
            vita_app.update_global_test(FileUploader.uploaded_content)